...
#define MAX_FILES_IN_DIR ((BLOCK_SIZE - sizeof(size_t)) / sizeof(struct os_file_entry))
#define DIRECTORY_PADDING (BLOCK_SIZE - sizeof(size_t) - MAX_FILES_IN_DIR*sizeof(struct os_file_entry))

PACKED struct os_file_entry {
...
#define MAX_DIRS_IN_ROOT ((BLOCK_SIZE - 2*sizeof(size_t)) / sizeof(struct os_directory))
#define ROOT_PADDING (BLOCK_SIZE - 2*sizeof(size_t) - MAX_DIRS_IN_ROOT*sizeof(struct os_directory))

PACKED struct os_directory {
...
static_assert(sizeof(struct os_directory_entry) == BLOCK_SIZE, "wrong size");
static_assert(sizeof(struct os_root_directory)  == BLOCK_SIZE, "wrong size");
static_assert(sizeof(struct os_index_block)     == BLOCK_SIZE, "wrong size");
static_assert(sizeof(struct os_data_block)      == BLOCK_SIZE, "wrong size");
