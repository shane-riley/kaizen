...
MOUNT=testmount
if [ ! -f "./os" ]; then echo "Compilation Errors"; exit 0; fi
...
echo -ne "echo \"Fairwell, os\" > ${MOUNT}/dir0/file0.dat"
echo -ne "echo \"Fairwell, os\" >> ${MOUNT}/dir0/file0.dat"
echo -ne "echo \"Fairwell, os\" >> ${MOUNT}/dir0/file0.dat"
echo -ne "echo \"Fairwell, os\" >> ${MOUNT}/dir0/file0.dat"

echo "Fairwell, os" > ${MOUNT}/dir0/file0.dat
echo "Fairwell, os" >> ${MOUNT}/dir0/file0.dat
echo "Fairwell, os" >> ${MOUNT}/dir0/file0.dat
err=$((echo "Fairwell, os" >> ${MOUNT}/dir0/file0.dat) 2>&1)
echo $err
if [[ $err == *"abort"* ]] || [[ $err == *"not connected"* ]]
then
  echo "Program crashed";
