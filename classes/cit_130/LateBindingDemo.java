...
public class LateBindingDemo
{
    public static void main(String[] args)
    {
        ...
        if(discount.lessThan(simple)) // THIS IS MAGIC. lessThan exists in the Sale class, but will recognize and call the overriding bill method internally
        ...
        if (specialPrice.equalDeals(regularPrice)) // ALSO POLYMORPHISM MAGIC
