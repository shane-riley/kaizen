...
public class RLITest2
{
	public static void main (String [] args)
	{
		...
		// the ReallyLongInt2 methods that I have given you (the toString will
		// work from LLPlus but the output will be backwards and will not be
		// formatted correctly until you override toString() for ReallyLongInt2
		...
		R2 = new ReallyLongInt2("99999999999999999999");
		R3 = R1.add(R2);
